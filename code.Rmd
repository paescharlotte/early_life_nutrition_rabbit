...
setwd("") #to set up the working repository where you have saved the files 
...
distance_cc_vv_within<- read.table("C:/Within_distance_wunifrac_rajout.csv", header=TRUE, sep=";", dec=",")
